...
function assertValidSkillSlug(input: string): string {
...
function sanitizeSkillResourcePath(inputPath: string): string {
...
async function loadSkillFile(slug: string): Promise<string> {
